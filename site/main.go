...
func App(props goat.Props) goat.Block {
	...
	propsToPass := goat.Props{"inputValue": inputValue, "component_1602885801659547044": component_1602885801659547044, "elements": elements}
	for k, v := range props {
		propsToPass[k] = v
	}
	...
	block := block8604571377814938500generator(propsToPass)
